...
const AboutPage = () => {
  return (
    /* flex flex-col justify-between garantează că footerul va fi împins jos chiar dacă ecranul este foarte mare */
    <div className="bg-stone-50 min-h-screen font-sans text-stone-800 antialiased overflow-x-hidden flex flex-col justify-between">
      
      {/* Container pentru tot conținutul util al paginii */}
      <div className="w-full flex-grow">
        ...
        <section className="relative h-[65vh] md:h-[80vh] w-full flex items-center justify-center overflow-hidden mb-24">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <p className="text-stone-200 text-base md:text-xl font-light max-w-2xl mx-auto leading-relaxed border-t border-white/20 pt-6">
              Transformăm emoțiile în povești florale memorabile și aducem frumusețea naturii direct în momentele voastre speciale.
            </p>
          </div>
        </section>
        ...
        {/* 3. STATISTICI */}
        <section className="my-32 py-20 bg-stone-950 text-white block clear-both relative z-10">
      ...
      {/* FOOTERUL COMPONENTĂ INTEGRAT LA FINAL */}
      <Footer />
